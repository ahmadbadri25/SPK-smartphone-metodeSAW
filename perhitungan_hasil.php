    ...
    <div class="panel-heading">
                    ...
                    <div class="datatable table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php
                                $nomor = 0;
                                $hasil = mysqli_query($conn, "SELECT * FROM normal, alternatifhp WHERE normal.idhp=alternatifhp.idhp");
                    ...
                    <?php
#Cari nilai maximal
$carimax = mysqli_query($conn, "SELECT max(harga) as max1,
								max(ram) as max2,
								max(memory) as max3,
								max(camera) as max4,
								max(layar) as max5
...
# Cari nilai minimal
$carimin = mysqli_query($conn, "SELECT min(harga) as min1,
								min(ram) as min2,
								min(memory) as min3,
								min(camera) as min4,
								min(layar) as min5
