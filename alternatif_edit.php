                ...
                <!-- <div class="row">
                   ...
                   <?php
                    ...
                    if(isset($_POST['update'])) {
                        ...
                        $result = mysqli_query($conn, "UPDATE alternatifhp SET merk_hp='$merek', thn_hp='$thn' WHERE idhp=$ids");
...
<div class="col-md-6">
    ...
    <div class="panel-heading">
                    ...
                    $result = mysqli_query($conn, "SELECT * FROM alternatifhp WHERE idhp='$_GET[idhp]'") or die (mysqli_error($conn));
