...
$aksi = @$_GET['aksi'];
if (($aksi <> "") && ($id_normal <> "")) {
    mysqli_query($conn, "DELETE FROM normal WHERE id_normal='$id_normal'") or die(mysqli_error($conn));
                        ...
                        <div class="datatable table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    include "koneksi.php";
                                    $nomor = 0;
                                    $result = mysqli_query($conn, "SELECT * FROM normal, alternatifhp WHERE normal.idhp=alternatifhp.idhp") or die(mysqli_error($conn));
