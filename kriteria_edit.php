                ...
                <div class="row">
                   ...
                   <?php
                    ...
                    if(isset($_POST['update'])) {
                        ...
                        $result = mysqli_query($conn, "UPDATE kriteria SET nama_kriteria='$name', attribut='$att' WHERE id_kriteria=$id");
...
<div class="col-md-6">
    ...
    <div class="panel-heading">
                    ...
                    $result = mysqli_query($conn, "SELECT * FROM kriteria WHERE id_kriteria='$id_kriteria'") or die (mysqli_error($conn));
