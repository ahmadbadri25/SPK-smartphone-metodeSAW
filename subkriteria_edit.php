...
<div id="wrapper">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                ...
                <?php
                    $id_sub = $_GET['id_sub'];
                    $result = mysqli_query($conn, "SELECT * FROM subkriteria WHERE id_sub='$id_sub'") or die (mysqli_error($conn));
...
<div class="col-md-6">
    ...
    <div class="panel-heading">
                    ...
                    if(isset($_POST['update'])) {
                        ...
                        $result = mysqli_query($conn, "UPDATE subkriteria SET id_kriteria='$id', nama_sub='$ket', nilai='$nilai', keterangan='$bobot' WHERE id_sub='$id_sub'") or die(mysqli_error($conn));
