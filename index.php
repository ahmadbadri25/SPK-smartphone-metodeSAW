                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="alert alert-warning">
                            Hallo,
                            <br />
                            Selamat datang di web applikasi Pemilihan smartphone Terbaik. Didalam web ini Anda dibantu oleh sistem dalam menentukan smartphone apa yang akan anda beli. Dengan memasukkan kriteria kriteria tertentu, Anda akan langsung diberikan hasil smartphone apa yang cocok dengan keadaan Anda.
                            Thanks <br>
                            SPK TUGAS Pemrogaman Web Lanjut
                            <br />
                        </div>
                    </div>
                </div>
