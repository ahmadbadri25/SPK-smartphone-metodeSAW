...
$aksi = @$_GET['aksi'];
if (($aksi <> "") && ($id_sub <> "")) {
    mysqli_query($conn, "DELETE FROM subkriteria WHERE id_sub='$id_sub'") or die(mysqli_error($conn));
                        ...
                        <div class="datatable table-responsive">
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    include "koneksi.php";
                                    $nomor = 0;
                                    $result = mysqli_query($conn, "SELECT * FROM subkriteria, kriteria WHERE subkriteria.id_kriteria=kriteria.id_kriteria order by subkriteria.id_sub asc") or die(mysqli_error($conn));
